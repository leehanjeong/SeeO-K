...
def preprocess_convnet(cloth, back):
    ...
    cv2.imwrite('../image_data/gray_background_removed.png', gray_img)
    ...
    resized_im = cv2.resize(gray_img, dsize=(150, 216), interpolation=cv2.INTER_AREA)
