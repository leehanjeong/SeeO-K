...
HSV = {
    ...
    (240/2, 100*(255/100), 51*(255/100)): '어두운 남색',
    ...
    (0, 0, 100*(255/100)): '흰색',
    (0, 0, 50*(255/100)): '회색',
    (60/2, 1*(255/100), 85*(255/100)): '밝은회색',
    (214/2, 8*(255/100), 35*(255/100)): '어두운 회색',
    (329/2, 81*(255/100), 50*(255/100)): '자주색',
    (347/2, 71*(255/100), 85*(255/100)): '라즈베리색',
    (327/2, 78*(255/100), 89*(255/100)): '형광분홍색',
    ...
    (54/2, 69*(255/100), 99*(255/100)): '화사한 노란색',
    ...
    (58/2, 37*(255/100), 36*(255/100)): '카키',
    (22/2, 50*(255/100), 25*(255/100)): '갈색',
    (129/2, 59*(255/100), 26*(255/100)): '어두운 초록색',
    ...
    (45/2, 33*(255/100), 83*(255/100)): '따뜻한 베이지색',
    (34/2,28*(255/100),65*(255/100)): '연한 갈색',
    (47/2,34*(255/100),48*(255/100)): '연한초콜릿 갈색',
    (2/2,64*(255/100),67*(255/100)): '토마토 빨간색',
    (87/2,45*(255/100),70*(255/100)): '녹차색',
    (86/2,41*(255/100),56*(255/100)): '올리브 초록색',
    (182/2,82*(255/100),63*(255/100)): '에메랄드 초록색',
    (246/2,28*(255/100),82*(255/100)): '연한 바이올렛 보라색',
    (190/2,17*(255/100),94*(255/100)): '연한 아쿠아 하늘색',
    (346/2,54*(255/100),88*(255/100)): '장미빛 분홍색',
    (343/2,15*(255/100),65*(255/100)):'코코아 갈색',
